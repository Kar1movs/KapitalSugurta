...
// let dNoneTimeOneJs = document.querySelector(".logo-dark")
...
logoLight.classList.add("d-block");
...
const enableDarkMode = () => {
	...
	logoDark.classList.add("d-block");
	logoDark.classList.remove("d-none");
	logoLight.classList.remove("d-block");
...
const disableDarkMode = () => {
	...
	logoDark.classList.remove("d-block");
	logoDark.classList.add("d-none");
